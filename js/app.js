// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || 'selectedAPIs = ["dyttzy", "bfzy", "tyyszy", "ffzy", "zy360", "maotaizy"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = selectedAPIs = ["tyyszy", "bfzy", "dyttzy", "ruyi"];
