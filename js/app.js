// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["dyttzy", "bfzy", "tyyszy", "ffzy", "zy360", "maotaizy", "wolong", "jisu", "dbzy", "mozhua", "mdzy", "zuid", "yinghua", "wujin", "wwzy", "ikun", "lzi", "bdzy", "hongniuzy", "xinlangaa", "ckzy", "ukuapi", "zyk1080", "hhzyapi", "subocaiji", "p2100", "aqyzy", "yzzy", "myzy", "rycj", "jinyingzy", "guangsuapi"]
'); // 默认选中资源
